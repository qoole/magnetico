...
func (r *rabbitMQ) QueryTorrents(query string, epoch int64, orderBy OrderingCriteria, ascending bool, limit uint64, lastOrderedValue *uint64, lastID *uint64) ([]TorrentMetadata, error) {
